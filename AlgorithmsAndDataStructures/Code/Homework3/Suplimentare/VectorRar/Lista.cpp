...
void pushBack(List &myList, int val, int index)
{
...
void pushFront(List &myList, int val, int index)
{
    Node* newNode = new Node;
    newNode->value = val;
    newNode->index = index;
...
void insertAt(List &myList, int val, int poz, int index)
{
    if(poz == 0)
    {
        pushFront(myList, val, index);
    }
    else
    {
...
void insertBefore(List &myList, int val, int mark, int index)
{
    if(myList.head != NULL)
    {
...
void insertAfter(List &myList, int val, int mark, int index)
{
    Node* crt = myList.head;
